    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      ...
      >
        <div className="p-4 border-b border-ui-border flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="p-1 hover:bg-ui-accent rounded-md transition-colors"
          >
                  ...
                  <div className="flex items-center gap-4">
                    <div
                      className={`p-2 rounded-lg transition-colors ${
                        selectedTarget === vol.name
                          ? "bg-brand text-white"
                          : "bg-ui-accent text-text-sub group-hover:text-text-main"
                      }`}
                    >
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-text-sub opacity-60 font-mono mt-0.5">
                        {vol.mountpoint}
                      </p>
                    </div>
                  </div>
